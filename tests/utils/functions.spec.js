...
describe('The function utilities', function () {
    ...
    it('should return the names of the parameters of the given function', /* jshint unused:false */ function () {
    ...
    it('should return the number of parameters of the given function', /* jshint unused:false */ function () {
